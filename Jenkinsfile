      ...
      parallel {
        ...
        stage('Quality Tests') {
          steps {
            ...
            sh 'docker tag nodeapp-dev:trunk bvuppala/nodeapp-dev:latest'
            sh 'docker push bvuppala/nodeapp-dev:latest'
          }
        }
      ...
      steps {
        retry(count: 3) {
          timeout(time: 10, unit: 'MINUTES') {
            sh 'docker tag nodeapp-dev:trunk bvuppala/nodeapp-prod:latest'
            sh 'docker push bvuppala/nodeapp-prod:latest'
            sh 'docker save bvuppala/nodeapp-prod:latest | gzip > nodeapp-prod-golden.tar.gz'
          }
